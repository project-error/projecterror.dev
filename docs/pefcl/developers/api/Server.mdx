...
<ExportComponent
  ...
  name="createAccount"
  luaExample={
    'exports.pefcl:createUniqueAccount(source, { identifier, name, type })'
  }
  jsExample={
...
[Interface: Account](https://github.com/project-error/pefcl/blob/main/typings/Account.ts)
...
[Interface: Cash](https://github.com/project-error/pefcl/blob/main/typings/Cash.ts)
...
[Interface: Transaction](https://github.com/project-error/pefcl/blob/main/typings/Transaction.ts)
...
[Interface: Invoice](https://github.com/project-error/pefcl/blob/main/typings/Invoice.ts)
