...
<ExportComponent
  name="getTotalBankBalanceByIdentifier"
  luaExample={'exports.pefcl:getTotalBankBalanceByIdentifier(source, identifier)'}
  jsExample={'await exports.pefcl.getTotalBankBalanceByIdentifier(source, identifier)'}
  tsExample={'await exports.pefcl.getTotalBankBalanceByIdentifier(source: number, identifier: string)'}
  desc="Retrieve total bank balance."
/>
...
<ExportComponent
  ...
  luaExample={
    'exports.pefcl:addBankBalanceByIdentifier(source, { identifier, amount, message })'
  }
  jsExample={
...
<ExportComponent
  ...
  luaExample={
    'exports.pefcl:removeBankBalanceByIdentifier(source, { identifier, amount, message })'
  }
  jsExample={
...
<ExportComponent
  isOffline
  name="createAccount"
  luaExample={'exports.pefcl:createUniqueAccount(source, { identifier, name, type })'}
  jsExample={'await exports.pefcl.createUniqueAccount(source, { identifier, name, type })'}
  tsExample={
...
<ExportComponent
  ...
  name="createInvoice"
  luaExample={
    'exports.pefcl:createInvoice(source, { to = to, toIdentifier = toIdentifier, from = from, fromIdentifier = fromIdentifier, amount = amount, message = message, recieverAccountId = recieverAccountId, expiresAt = expiresAt })'
  }
  jsExample={
...
- Export arguments:
  ...
  - fromIdentifier: `string`
    - Identifier of the player who should receive the money from the invoice, _unless_ `receiverAccountIdentifier` is specified.
  - amount: `number`
    - Decides how much the invoice should be
  - message: `string`
    - Invoice description. Examples:
      - "For the repairs"
  - receiverAccountIdentifier?: `number`
